                ...
                <?php if (!empty($products)): ?>
                    <div class="mb-12">
                        <div class="flex items-center mb-6">
                            <div class="mr-2">
                                <span class="font-YekanBakh-Bold bg-orange-200 rounded-full px-4 py-1">محصولات این کالکشن</span>
                                <p class="mt-2">برای مشاهده جزئیات کلیک کنید</p>
                            </div>
                        </div>
                                ...
                                <?php foreach ($products as $product): ?>
                                    <div class="swiper-slide">
                                        <div class="group/item">
                                            <a class="relative w-full" href="<?= base_url('product/' . $product['slug']) ?>">
