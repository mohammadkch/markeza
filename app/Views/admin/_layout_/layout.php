...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?= $assetsPath ?>favicon/favicon192x192.jpg">
    <link rel="icon" type="image/jpg" sizes="32x32" href="<?= $assetsPath ?>favicon/favicon32x32.jpg">
