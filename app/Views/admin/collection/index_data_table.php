                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">
                    ...
                    <td class="px-5 py-4">
                        <?php if (!empty($item['thumbnail'])): ?>
                            <img src="<?= base_url($item['thumbnail']) ?>" class="w-12 h-12 object-cover rounded-lg border">
                        <?php else: ?>
                    ...
                    <td class="px-5 py-4">
                        <div class="flex space-x-2 rtl:space-x-reverse">
                            <a href="<?= site_url('admin/collection/edit/' . $item['id']) ?>" class="text-primary hover:text-primary-800 dark:text-primary-400 dark:hover:text-primary-300">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                            </a>
                            <button type="button" class="delete-btn text-red-600 hover:text-red-800" data-id="<?= $item['id'] ?>" data-url="<?= site_url('admin/collection/delete') ?>">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php else: ?>
    <div class="alert alert-warning text-center py-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
        ...
        <h5 class="text-lg font-semibold text-gray-800 dark:text-gray-200">کالکشنی یافت نشد</h5>
        <p class="text-gray-600 dark:text-gray-400">هیچ کالکشنی با جستجوی شما مطابقت ندارد</p>
    </div>
<?php endif; ?>