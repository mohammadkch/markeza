                ...
                <div class="lg:col-span-3 space-y-8">
                    ...
                    <div class="bg-white rounded-2xl drop-shadow-lg p-6 dark:bg-custom-dark dark:border dark:border-gray-700">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
                            <div>
                                <h1 class="font-black text-2xl with-highlight dark:text-gray-200">مدیریت کالکشن‌ها</h1>
                                <p class="text-gray-600 dark:text-gray-400 mt-1">لیست تمام کالکشن‌های فروشگاه</p>
                            </div>
                            <div class="mt-4 md:mt-0">
                                <a href="<?= site_url('admin/collection/create') ?>" class="bg-primary text-white py-2.5 px-4 rounded-lg hover:bg-primary-600 transition duration-200 shadow-sm hover:shadow flex items-center">
                        ...
                        <div id="search-result">
                            <?= $this->include('admin/collection/index_data_table') ?>
                        </div>
                    </div>
        ...
        <div class="relative p-4 w-full max-w-md m-auto flex items-center min-h-screen">
            <div class="bg-white relative w-full dark:bg-custom-dark rounded-2xl shadow-soft p-6">
                <div class="text-center">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-6">آیا از حذف این کالکشن اطمینان دارید؟</p>
